...
import com.bay.filemanager.payload.UploadFileResponse;
...
public class FileController {
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable String fileName, HttpServletRequest request) {
        ...
        return ResponseEntity.ok()
                ...
                //.header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + resource.getFilename() + "\"") //Descarga automaticamente
